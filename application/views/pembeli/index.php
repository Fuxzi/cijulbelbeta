<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-users mr-2"></i>Data Pembeli</h1>
        <a href="<?= site_url('pembeli/tambah') ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus mr-1"></i> Tambah Pembeli</a>
    </div>
